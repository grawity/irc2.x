...
extern int m_join(), m_part(), m_text(), m_service();
#ifdef MSG_MAIL
extern int m_mail();
#endif
...
struct Message msgtab[] = {
  ...
  { MSG_TIME,    m_time,     0, 1, 0 },
  { MSG_REHASH,  m_rehash,   0, 1, 0 },
  { MSG_NAMES,   m_names,    0, 1, 0 },
  { MSG_NAMREPLY,m_namreply, 0, 3, 0 },
  { MSG_ADMIN,   m_admin,    0, 1, 0 },
  { MSG_TRACE,   m_trace,    0, 1, 0 },
  { MSG_LINREPLY,m_linreply, 0, 2, 0 },
  { MSG_NOTICE,  m_notice,   0, 2, 1 },
  { MSG_LUSERS,  m_lusers,   0, 1, 0 },
  { MSG_VOICE,   m_private,  0, 2, 1 },
  { MSG_GRPH,    m_private,  0, 2, 1 },
  { MSG_XTRA,    m_private,  0, 2, 1 },
  { MSG_MOTD,    m_motd,     0, 2, 1 },
#ifdef MSG_MAIL
  { MSG_MAIL,    m_mail,     0, 6, 1 },
#endif
  { MSG_MODE,    m_mode,     0, 6, 0 },
  { MSG_KICK,    m_kick,     0, 3, 0 },
